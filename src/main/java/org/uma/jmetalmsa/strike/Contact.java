...
public class Contact {
    ...
    public Contact(char chain){
		_chain = chain;		_num_contacts = 0;
   }

   public Contact(int seq_length, char chain){
	_chain = chain;		_num_contacts = 0;	
	_pairs =  new ArrayList<ArrayList<Integer>>(seq_length);
    }
   
   public final char chain_name() {return _chain;  	}
   
   public final void set_seq(String sequence){	_sequence = sequence;	}
    public final String get_seq_name()	{  return _seq_name;	}
    
   public final String get_sequence(){ return _sequence; }
   public final void set_seq_name(String seq_name) { 	_seq_name = seq_name;	}
   public final int get_seq_length()	{ return _sequence.length();	}

   public final int num_contacts(){return _num_contacts;	}
   
   public final ArrayList<ArrayList< Integer>> get_contacts(){	return _pairs;	}
