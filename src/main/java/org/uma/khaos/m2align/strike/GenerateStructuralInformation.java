...
public class GenerateStructuralInformation {
  ...
  public static void main(String[] args) throws Exception {
    ...
    for (Map.Entry<String, ProteinSequence> entry : sequences.entrySet()) {
      ...
      if (downloadPDB(sequenceName, pdbFileName)) {
        System.out.println(
            "PDBFile of Sequence Name " + sequenceName + " has been downloaded " + pdbFileName);
  ...
  public static boolean downloadPDB(String sequenceKey, String pdbFileName) {
    ...
    try {
      ...
      URL url = new URL(
          "http://www.rcsb.org/pdb/downloadFile.do?fileFormat=pdb&compression=NO&structureId="
              + sequenceKey.substring(0, 4));
  ...
  public static boolean exeStrikeContactGenerator(String exeStrike, String seqName,
      String pdbFileName, String Chain, String pathToSaveContact)
      throws Exception {

    try {

      String Comando =
          exeStrike + " " + seqName + " " + pdbFileName + " " + Chain + " " + pathToSaveContact;
