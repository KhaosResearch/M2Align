...
public class ChartContainer2<S extends Solution<?>> {
  ...
  public ChartContainer2(String name) {
    this(name, 0);
  }

  public ChartContainer2(String name, int delay) {
    this.name = name;
    this.delay = delay;
  ...
  public ChartContainer2 setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public ChartContainer2 setDelay(int delay) {
    this.delay = delay;
    return this;
  }
