...
package org.uma.m2align.experiment;
...
import org.uma.m2align.objective.impl.SumOfPairsObjective;
...
//       }
       ...
       ProblemName = "BB" + RV +"0";
        ...
        problemList.add(new BAliBASEMSAProblem(ProblemName, dataBaseDirectory, objectiveList));
